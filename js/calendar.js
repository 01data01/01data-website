...
class CalendarManager {
    ...
    getTasks(dateStr) {
        ...
        if (this.taskCache.has(dateStr)) {
            return this.taskCache.get(dateStr);
        }
        
        const tasks = this.assistant.tasks.filter(task => task.dueDate === dateStr);
        this.taskCache.set(dateStr, tasks);
